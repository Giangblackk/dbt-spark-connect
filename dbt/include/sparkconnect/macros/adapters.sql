...
{% macro sparkconnect__alter_column_type(relation,column_name,new_column_type) -%}
...
{% macro sparkconnect__check_schema_exists(information_schema,schema) -%}
...
{% macro sparkconnect__create_schema(relation) -%}
...
{% macro sparkconnect__drop_relation(relation) -%}
...
{% macro sparkconnect__drop_schema(relation) -%}
...
{% macro sparkconnect__get_columns_in_relation(relation) -%}
...
{% macro sparkconnect__list_relations_without_caching(schema_relation) -%}
'''creates a table of relations withough using local caching.'''
{% endmacro %}

{% macro sparkconnect__list_schemas(database) -%}
...
{% macro sparkconnect__rename_relation(from_relation, to_relation) -%}
...
{% macro sparkconnect__truncate_relation(relation) -%}
...
{% macro sparkconnect__current_timestamp() -%}
